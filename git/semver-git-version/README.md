# GitHub Semver-Git-Version Action

The current version in this repo was based off of [**semver-git-version** v0.1.4](https://github.com/codedesignplus/semver-git-version/releases/tag/v0.1.4) (specifically [this commit](https://github.com/codedesignplus/semver-git-version/commit/03ef2330328b1911a81efe90acb7c8a998bff3df))`
...
- [GitHub Semver-Git-Version Action](#github-semver-git-version-action)
  - [Updates to the action](#updates-to-the-action)
  - [Semver-Git-Version action](#semver-git-version-action)
...
2. **Add the `Calculate Version` step**:
    ...
    - name: Calculate Version
      id: version
      uses: rwaight/actions/git/semver-git-version@main
      with:
