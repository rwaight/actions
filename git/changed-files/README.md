...
The current version in this repo was based off of [**changed-files** v45.0.3](https://github.com/tj-actions/changed-files/releases/tag/v45.0.3)
- specifically [this commit](https://github.com/tj-actions/changed-files/commit/c3a1bb2c992d77180ae65be6ae6c166cf40f857c)
  ...
  changed_files:
    ...
    steps:
      ...
      - name: Get changed files
        id: changed-files
        uses: rwaight/actions/git/changed-files@main
