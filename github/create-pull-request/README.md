...
The current version in this repo was based off of [**create-pull-request** v6.0.2](https://github.com/peter-evans/create-pull-request/releases/tag/v6.0.2) (specifically [this commit](https://github.com/peter-evans/create-pull-request/commit/70a41aba780001da0a30141984ae2a0c95d8704e))
